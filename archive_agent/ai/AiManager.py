...
class AiManager(RetryManager):
    ...
    def get_prompt_query(question: str, context: str) -> str:
        return "\n".join([
            ...
            "",
            "- `answer_list`:",
            "    A list of detailed, self-contained answers based solely on the context.",
            "    Each entry covers a distinct aspect: start with a clear definition or key fact,"
            "    explain thoroughly with examples or steps, and include practical applications or implications.",
            "    Use light Markdown for emphasis (e.g., **bold**, *italic*, - bullets for sub-lists),",
