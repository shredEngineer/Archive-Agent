...
class AiQuery:
    ...
    def get_prompt_query(question: str, context: str) -> str:
        return "\n".join([
            ...
            "- Target 10–20 `answer_list` items when the context allows; never fewer than 5 unless content is truly sparse.",
            ...
            "    A list of 4–8 specific, well-formed follow-up questions that extend the topic.",
